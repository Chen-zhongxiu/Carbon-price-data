...
forecast_multi_step_offline <- function(X_full_log, fit_offline, N_state,
  ...
  # Extended-state growth factor g_j = c_{curr_state(j)}
  ...
  # Starting points: last k origins, ensuring each has H-step truth available
...
sigma_init   <- c(0.00855 , 0.009456)
lambda_init  <- c(0.132, 0.3556)
mu_beta_init <- c(-0.002, -0.004)
s_beta_init  <- c(0.06435, 0.08342)
